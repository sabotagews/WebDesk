...
<main class="container" role="main">
	<div class="py-5 text-center">
		<h2>Pagos</h2>
		<p class="lead">Captura de pagos ( pagos a proveedores ) de <strong>reservaci&oacute;n.</strong></p>
	</div>
			...
			<div class="d-flex col-12 mt-4 mb-4 p-0">
				<div class="col-2">
					<div class="col">
						...
						<input type="date" class="form-control" id="pagoFechaAplicacion" name="pagoFechaAplicacion" placeholder="dd/mm/yyyy" pattern="(^(((0[1-9]|1[0-9]|2[0-8])[\/](0[1-9]|1[012]))|((29|30|31)[\/](0[13578]|1[02]))|((29|30)[\/](0[4,6,9]|11)))[\/](19|[2-9][0-9])\d\d$)|(^29[\/]02[\/](19|[2-9][0-9])(00|04|08|12|16|20|24|28|32|36|40|44|48|52|56|60|64|68|72|76|80|84|88|92|96)$)" required>
					</div>
					<div class="col">
