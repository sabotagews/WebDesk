...
<main class="container" role="main">
	...
	<div class="row" id="contenedor_reservacion" style="display: none">
		...
		<div class="d-flex col-12 mt-4 p-0">
			<div class="mr-auto p">
				<h1 id="cliente"></h1>
			</div>
			<div>
		...
		<div class="col-12 m-auto">
			...
			<form id="form_cobro" class="needs-validation" novalidate="">
				...
				<div class="row">
					<p class="col-6 p-0">
						<span class="text-muted">Hotel: </span><strong id="reservacionHotel"></strong><br />
						<span class="text-muted">CheckIn: </span><strong id="reservacionCheckIn"></strong><br />
						<span class="text-muted">CheckOut: </span><strong id="reservacionCheckOut"></strong><br />
						<span class="text-muted">Destino: </span><strong id="reservacionDestino"></strong><br />
						<span class="text-muted">Plan: </span><strong id="reservacionPlan"></strong><br />
						<span class="text-muted">Servicio: </span><strong id="reservacionServicio"></strong><br />
						<span class="text-muted">Habitaciones: </span><strong id="reservacionHabitaciones"></strong><br />
					</p>
					<p class="col-6 text-right p-0">
						<span class="text-muted">Proveedor: </span><strong id="reservacionProveedor"></strong><br />
						<span class="text-muted">Coste: </span><strong id="reservacionCoste"></strong><br />
						<span class="text-muted">Precio: </span><strong id="reservacionPrecio"></strong><br />
						<span class="text-muted">Saldo: </span><strong id="reservacionSaldo"></strong><br />
						<span class="text-muted">Cobro: </span><strong id="reservacionStatusCobro"></strong><br />
						<span class="text-muted">Pago: </span><strong id="reservacionStatusPago"></strong><br />
					</p>
					<hr class="col-12">
					<h5 class="text-muted">Detalle de la Reservaci&oacute;n</h5>
					<p class="col-12 p-0" id="reservacionDetalle">
					</p>
					<hr class="col-12">
				</div>
