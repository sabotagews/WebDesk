...
# Tiempo de Generación: 2020-12-01 01:39:58 +0000
# ************************************************************
...
INSERT INTO `reservaciones` (`reservacionId`, `proveedorId`, `clienteId`, `reservacionServicio`, `reservacionDestino`, `reservacionHotel`, `reservacionPlan`, `reservacionCheckIn`, `reservacionCheckOut`, `reservacionHabitaciones`, `reservacionDetalle`, `reservacionCoste`, `reservacionPrecio`, `reservacionUtilidad`, `reservacionStatus`)
VALUES
	(2,1,1,'BUS','ACAPULCO','IBEROSTAR','EP','2020-12-18','2020-11-10','2','DETALLE TEST',100.00,200.00,100.00,'2'),
	(3,2,3,'PQ','ACAPULCO','IBEROSTAR','CD','2020-11-28','2020-11-30','2','TEST',25000.00,27000.00,2000.00,'3'),
	(4,1,2,'AL','ACAPULCO','FOUR SEASONS','TI','2020-11-30','2020-12-02','2','ESTE ES EL DETALLE DE LA RESERVACION',5000.00,6500.00,1500.00,'0'),
	(5,1,2,'AL','ACAPULCO','IBEROSTAR','CD','2020-11-21','2020-11-28','1','TEST',12000.00,14000.00,2000.00,'1');
